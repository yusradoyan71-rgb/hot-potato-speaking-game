...
class SoundEngine {
  ...
  playClick() {
    ...
    try {
      ...
      // Audio failure should never break game
    }
  }
  ...
  playBoom() {
    ...
    try {
      ...
      // 2. White Noise Blast (if createBuffer is supported)
...
const gameState = {
  ...
  // Safety Lock (prevents double clicking / race conditions)
  isProcessingTurn: false,
  
  // Decks for Anti-Repetition
  questionPool: [],
  usedQuestions: [],
  chaosPool: [],
  usedChaos: []
...
/* ============================================================================
   5. DECK MANAGEMENT & ANTI-REPETITION (Shuffling & Exhaustion Reshuffle)
   ============================================================================ */
...
function startRound() {
  ...
  if (gameState.isChaosRound) {
    ...
    // Special events on ~25% of regular rounds (round 2+)
...
console.log('✅ script.js written cleanly, lines:', code.split('\n').length);
