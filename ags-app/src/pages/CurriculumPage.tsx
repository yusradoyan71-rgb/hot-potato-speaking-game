      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '24px', alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          {(activeFilter === 'all' || activeFilter === 'tasks') && (
            currentPlan.subject_id === 'sozel-yetenek' ? (
            ...
            ) : currentPlan.subject_id === 'cografya' ? (
              <div
                className="glass-panel"
                style={{
                  borderRadius: '20px',
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  <div>
                    ...
                    <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', margin: '4px 0 0' }}>
                      Çalışmanızı tamamladığınız konuyu işaretleyin (2 Görev = %100)
                    </p>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '1.75rem', fontWeight: 900, color: 'var(--color-primary)', lineHeight: 1 }}>
                    ...
                    <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)', marginTop: '4px' }}>
                      {currentSubjectStats?.completedTasks || 0} / 2 Tamamlandı
                    </div>
                  </div>
                </div>

                {/* Coğrafya Progress Bar */}
                <div style={{ width: '100%', height: '12px', backgroundColor: 'rgba(0, 0, 0, 0.08)', borderRadius: '999px', overflow: 'hidden', marginBottom: '12px' }}>
                  <div
                    style={{
                      width: `${currentSubjectStats?.percentage || 0}%`,
                ...
                {/* 2-Step Scale Indicator: 0/2 = %0, 1/2 = %50, 2/2 = %100 */}
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '22px', padding: '0 2px' }}>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 0 ? 700 : 400 }}>0/2 (%0)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 1 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 1 ? 'var(--color-primary)' : 'inherit' }}>1/2 (%50)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 2 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks === 2 ? 'var(--color-success)' : 'inherit' }}>2/2 (%100)</span>
                </div>

                {/* 2 Coğrafya Checkboxes */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {currentPlan.sections[0]?.tasks.map((task) => {
                    const isDone = completedTaskIds.has(task.id);
                    return (
            ...
            ) : currentPlan.subject_id === 'egitim-bilimleri' ? (
              <div
                className="glass-panel"
                style={{
                  borderRadius: '20px',
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                  <div>
                    ...
                    <p style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', margin: '4px 0 0' }}>
                      Çalışmanızı tamamladığınız konuyu işaretleyin (11 Görev = %100)
                    </p>
                  </div>
                  <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '1.75rem', fontWeight: 900, color: 'var(--color-primary)', lineHeight: 1 }}>
                    ...
                    <div style={{ fontSize: '0.78rem', color: 'var(--text-muted)', marginTop: '4px' }}>
                      {currentSubjectStats?.completedTasks || 0} / 11 Tamamlandı
                    </div>
                  </div>
                </div>

                {/* Eğitim Bilimleri Progress Bar */}
                <div style={{ width: '100%', height: '12px', backgroundColor: 'rgba(0, 0, 0, 0.08)', borderRadius: '999px', overflow: 'hidden', marginBottom: '12px' }}>
                  <div
                    style={{
                      width: `${currentSubjectStats?.percentage || 0}%`,
                ...
                {/* 11-Step Scale Indicator */}
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', fontSize: '0.72rem', color: 'var(--text-muted)', marginBottom: '22px', gap: '4px', padding: '0 2px' }}>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 0 ? 700 : 400 }}>0/11 (%0)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 1 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 1 ? 'var(--color-primary)' : 'inherit' }}>1/11 (%9)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 2 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 2 ? 'var(--color-primary)' : 'inherit' }}>2/11 (%18)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 3 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 3 ? 'var(--color-primary)' : 'inherit' }}>3/11 (%27)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 4 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 4 ? 'var(--color-primary)' : 'inherit' }}>4/11 (%36)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 5 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 5 ? 'var(--color-primary)' : 'inherit' }}>5/11 (%45)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 6 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 6 ? 'var(--color-primary)' : 'inherit' }}>6/11 (%55)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 7 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 7 ? 'var(--color-primary)' : 'inherit' }}>7/11 (%64)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 8 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 8 ? 'var(--color-primary)' : 'inherit' }}>8/11 (%73)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 9 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 9 ? 'var(--color-primary)' : 'inherit' }}>9/11 (%82)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 10 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 10 ? 'var(--color-primary)' : 'inherit' }}>10/11 (%91)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 11 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks === 11 ? 'var(--color-success)' : 'inherit' }}>11/11 (%100)</span>
                </div>

                {/* 11 Eğitim Bilimleri Checkboxes */}
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                  {currentPlan.sections[0]?.tasks.map((task) => {
                    const isDone = completedTaskIds.has(task.id);
                    return (
            ...
            ) : currentPlan.subject_id === 'mevzuat' ? (
              <div
                className="glass-panel"
                style={{
                  borderRadius: '20px',
              ...
              >
                ...
                {/* 5-Step Scale Indicator: 0/5 = %0, 1/5 = %20, 2/5 = %40, 3/5 = %60, 4/5 = %80, 5/5 = %100 */}
                <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '22px', padding: '0 2px' }}>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 0 ? 700 : 400 }}>0/5 (%0)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 1 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 1 ? 'var(--color-primary)' : 'inherit' }}>1/5 (%20)</span>
                  <span style={{ fontWeight: currentSubjectStats?.completedTasks === 2 ? 700 : 400, color: currentSubjectStats && currentSubjectStats.completedTasks >= 2 ? 'var(--color-primary)' : 'inherit' }}>2/5 (%40)</span>
